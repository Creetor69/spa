...
export const Sections: React.FC<SectionsProps> = ({
  ...
  return (
    <div className="relative w-full text-lotus select-none pt-16">
      ...
      {activeTab === "home" && (
        <div id="home-page-container" className="w-full">
          ...
          <section
            id="section-hero"
            className="relative w-full h-[100vh] flex flex-col justify-between px-6 py-12 md:px-16 overflow-hidden"
          >
            ...
            <div className="z-10 my-auto max-w-4xl text-left md:pl-8">
              <motion.div
                ...
                className="space-y-6"
              >
                <div className="inline-flex items-center gap-2.5 px-3 py-1 rounded-full bg-brass/10 border border-brass/20 text-brass text-[10px] tracking-[0.25em] uppercase font-black">
                  <MapPin size={11} />
                  <span>Located in JP Nagar, Bangalore</span>
                </div>
                
                <h1 className="font-serif text-5xl md:text-7xl tracking-tight leading-[1.08] text-lotus font-light">
                  A Meditative Men's <br />
                  <span className="italic text-brass font-normal">Wellness Sanctuary</span>
                </h1>
                
                <p className="font-sans text-sm md:text-base text-lotus/85 leading-relaxed max-w-xl tracking-wide font-light">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4 max-w-md">
                  <button
                    ...
                    className="px-8 py-4 bg-brass hover:bg-lotus text-[#0c0f0e] hover:text-[#0c0f0e] font-sans font-black text-xs tracking-[0.2em] uppercase rounded-full shadow-2xl transition-all duration-300 flex items-center justify-center gap-2.5 group"
                  ...
                  <button
                    ...
                    className="px-8 py-4 bg-white/5 hover:bg-white/10 text-lotus border border-white/20 hover:border-brass/50 font-sans font-black text-xs tracking-[0.2em] uppercase rounded-full transition-all duration-300 flex items-center justify-center gap-2.5"
            ...
            <div className="z-10 flex justify-between items-end w-full border-t border-white/5 pt-4">
              <button
                ...
                className="flex gap-2 items-center text-[10px] font-bold font-sans text-stone/80 hover:text-brass transition-colors tracking-widest uppercase cursor-pointer focus:outline-none"
              >
                <Compass size={14} className="animate-spin-slow text-brass" />
                <span>Scroll down downstream</span>
              </button>
              <div className="text-right">
                <span className="font-serif text-lg italic text-brass font-light leading-none block">
                  The Sanctuary of Prana (प्राण)
                </span>
                <span className="font-sans text-[9px] tracking-[0.25em] text-stone uppercase font-bold">
                  Chapter I
                </span>
              </div>
            </div>
          ...
          <section
            id="section-elements"
            className="relative w-full h-[100vh] flex flex-col justify-between px-6 py-12 md:px-16 bg-gradient-to-b from-[#0c0f0e] via-[#101513] to-[#0c0f0e] overflow-hidden"
          >
            <div className="z-10 max-w-4xl mx-auto w-full my-auto flex flex-col justify-center">
              ...
              <div className="text-center mb-10">
                ...
                <h2 className="font-serif text-3xl md:text-4xl text-lotus font-light">
              ...
              <div className="space-y-6 max-w-3xl mx-auto w-full">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-serif text-xl text-brass font-semibold mb-1">
                      🌿 1. Relax (The Forest Grounding)
                    </h3>
                    <p className="font-sans text-xs md:text-sm text-lotus/80 leading-relaxed font-light">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-serif text-xl text-orange-400 font-semibold mb-1">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-serif text-xl text-emerald-400 font-semibold mb-1">
            ...
            <div className="z-10 flex justify-between items-end w-full border-t border-white/5 pt-4">
              <button
                ...
                className="flex gap-2 items-center text-[10px] font-bold font-sans text-stone/80 hover:text-brass transition-colors tracking-widest uppercase cursor-pointer"
              >
          ...
          >
            ...
            <div className="z-10 max-w-5xl mx-auto w-full my-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-7 text-left space-y-6">
                <span className="font-sans text-xs tracking-[0.3em] text-brass uppercase font-bold block">
                  The Authentic Touch
                </span>
                ...
                <p className="font-sans text-xs md:text-sm text-lotus/85 leading-relaxed font-light">
                ...
                <div className="space-y-3 pt-2">
                  <div className="flex gap-3 items-center text-xs text-lotus/90 font-sans">
                    <div className="w-5 h-5 rounded-full bg-brass/10 flex items-center justify-center text-brass">
                      <Check size={12} />
                    </div>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="px-6 py-3 bg-brass hover:bg-lotus text-[#0c0f0e] font-sans font-bold text-xs tracking-widest uppercase rounded-full transition-all duration-300 flex items-center gap-2"
          ...
          <section
            ...
            className="relative w-full h-[100vh] flex flex-col justify-between px-6 py-12 md:px-16 bg-[#090b0a] overflow-hidden"
          >
            <div className="z-10 max-w-4xl mx-auto w-full my-auto text-center space-y-12">
              <div>
                ...
                <p className="font-sans text-xs md:text-sm text-stone max-w-md mx-auto mt-2 tracking-wide font-light">
                    ...
                    <div className="space-y-4">
                      <div className="flex gap-1 text-brass">
                        {Array.from({ length: 5 }).map((_, i) => (
                          <Sparkles key={i} size={11} className="fill-brass" />
                        ))}
                      </div>
                      <p className="font-sans text-xs md:text-sm text-lotus/90 leading-relaxed font-light italic">
                        "{t.text}"
                      </p>
                    </div>
                    <div className="border-t border-white/5 pt-4 mt-6">
                      <h4 className="font-serif text-sm text-brass font-bold">{t.name}</h4>
                      <p className="font-sans text-[10px] text-stone tracking-wider uppercase font-semibold">{t.role}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <section
            ...
            className="relative w-full h-[100vh] flex flex-col justify-between px-6 py-12 md:px-16 bg-gradient-to-b from-[#0c0f0e] to-[#080a09] overflow-hidden"
          >
            <div className="z-10 max-w-5xl mx-auto w-full my-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              ...
              <div className="text-left space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div className="p-4 rounded-xl bg-white/5 border border-white/5 space-y-1">
                    <span className="text-brass text-xs tracking-wider font-bold block uppercase">Metro Proximity</span>
                    <span className="text-[11px] text-stone">Opposite JP Nagar Metro Station (1 Min walk)</span>
                  </div>
                  <div className="p-4 rounded-xl bg-white/5 border border-white/5 space-y-1">
                    <span className="text-brass text-xs tracking-wider font-bold block uppercase">Pristine Hygiene</span>
                    <span className="text-[11px] text-stone">Individual private suites with private showers</span>
                  </div>
                </div>
                ...
                <div className="pt-2 flex gap-4">
                  <button
                    ...
                    className="px-6 py-3 bg-brass hover:bg-lotus text-[#0c0f0e] font-sans font-bold text-xs tracking-widest uppercase rounded-full transition-all duration-300"
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-white/5 hover:bg-white/10 text-lotus border border-white/15 hover:border-brass/40 font-sans font-bold text-xs tracking-widest uppercase rounded-full transition-all duration-300"
              ...
              <div className="p-8 rounded-3xl border border-white/5 bg-stone-900/15 frosted-glass space-y-6 text-left">
                <h3 className="font-serif text-2xl text-lotus font-light">Sanctuary Details</h3>
                
                <div className="space-y-4">
                  <div className="flex gap-3 items-start text-xs md:text-sm font-sans">
                    <MapPin className="text-brass shrink-0 mt-0.5" size={16} />
                    <div>
                      <strong className="text-brass font-bold block">JP Nagar Address</strong>
                      <span className="text-lotus/80 font-light">
                  ...
                  <div className="flex gap-3 items-start text-xs md:text-sm font-sans">
                    <Phone className="text-brass shrink-0 mt-0.5" size={16} />
                    <div>
                      <strong className="text-brass font-bold block">Reserve Over Call</strong>
                      <span className="text-lotus/80 font-light">+91 98860 12345 / +91 80 4567 8910</span>
                    </div>
                  </div>

                  <div className="flex gap-3 items-start text-xs md:text-sm font-sans">
                    <Clock className="text-brass shrink-0 mt-0.5" size={16} />
                    <div>
                      <strong className="text-brass font-bold block">Working Hours</strong>
                      <span className="text-lotus/80 font-light">10:00 AM - 9:00 PM (Everyday)</span>
                    </div>
                  </div>
                </div>

                <div className="border-t border-white/5 pt-4 text-[11px] font-sans text-stone tracking-wider uppercase font-bold text-center">
            ...
            {/* Bottom Area */}
            <div className="z-10 flex justify-between items-end w-full border-t border-white/5 pt-4">
              <span className="text-[10px] font-bold font-sans text-stone/50 tracking-widest uppercase">
      ...
      {activeTab === "therapies" && (
        <section id="therapies-section" className="max-w-7xl mx-auto px-6 py-12 md:px-12 text-center">
          ...
          <div className="max-w-3xl mx-auto space-y-4 mb-12">
            ...
            <h1 className="font-serif text-4xl md:text-5xl text-lotus font-light leading-tight">
              Therapeutic Core <span className="italic text-brass font-normal">Services</span>
            </h1>
            <p className="font-sans text-sm text-lotus/80 max-w-xl mx-auto font-light leading-relaxed">
            ...
            {["All", "Classic", "Ayurvedic", "Combos", "Four Hands", "Add-Ons"].map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-full font-sans font-bold text-xs tracking-wider uppercase transition-all duration-300 cursor-pointer ${
                    isActive
                  ...
                  >
                    <div>
                      ...
                      <div className="flex justify-between items-center mb-4">
                        <span className="px-2.5 py-1 rounded-md bg-white/5 text-stone text-[9px] tracking-wider font-bold uppercase border border-white/5">
                          {srv.category}
                        </span>
                      ...
                      <h3 className="font-serif text-2xl text-lotus font-bold mb-2 group-hover:text-brass transition-colors">
                        {srv.name}
                      </h3>
                      
                      <p className="font-sans text-xs text-lotus/70 leading-relaxed font-light mb-6">
                        {srv.description}
                      </p>
                      ...
                      {srv.options && srv.options.length > 0 && (
                        <div className="space-y-2 mb-6">
                          <span className="text-[10px] tracking-wider text-brass uppercase font-bold block">
                            Select Session Tier:
                          </span>
                            ...
                            {srv.options.map((opt, oIdx) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`px-3 py-2 rounded-lg text-left font-sans text-xs font-semibold tracking-wide transition-all border flex justify-between items-center cursor-pointer ${
                                    isSelected
                                ...
                                >
                                  <span>{opt.name}</span>
                                  <span className="text-[11px]">{opt.price}</span>
                                </button>
                              );
                            })}
                          </div>
                      ...
                      <div className="space-y-2.5 border-t border-white/5 pt-4 mb-6">
                        <span className="text-[10px] tracking-wider text-stone uppercase font-bold block">
                          Key Benefits:
                        </span>
                        {srv.benefits.map((benefit, bIdx) => (
                          <div key={bIdx} className="flex gap-2.5 items-start text-xs font-sans text-lotus/85">
                    ...
                    <div className="border-t border-white/5 pt-4 flex items-center justify-between mt-auto">
                      <div className="space-y-0.5">
                        <span className="text-[9px] text-stone tracking-wider uppercase font-bold block">Total Price</span>
                        <span className="font-serif text-2xl text-brass font-black tracking-tight">{displayPrice}</span>
                      </div>
                      
                      <button
                        onClick={() => handleSelectServiceForBooking(srv.id, selectedOptIdx)}
                        className="px-4 py-2.5 bg-brass hover:bg-lotus text-[#0c0f0e] font-sans font-black text-xs tracking-wider uppercase rounded-full transition-all duration-300 flex items-center gap-1"
        ...
        <section id="memberships-section" className="max-w-7xl mx-auto px-6 py-12 md:px-12 text-center">
            ...
            {membershipsData.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  {m.name === "Prana Circle" && (
                    <div className="absolute top-0 right-0 px-3 py-1 bg-brass text-[#0c0f0e] text-[9px] tracking-widest uppercase font-black rounded-bl-xl">
                      POPULAR CHOICE
                    </div>
                  )}
                  ...
                  <div>
                    <div className="mb-6">
                      <span className={`px-2.5 py-1 rounded-md text-[10px] tracking-wider uppercase font-bold ${badgeTheme}`}>
                        {m.name}
                      </span>
                    </div>

                    <div className="flex items-baseline gap-1.5 mb-2">
                      <span className="font-serif text-4xl text-brass font-black tracking-tight">{m.price}</span>
                      <span className="text-xs text-stone tracking-wide">/ {m.period}</span>
                    </div>
                    ...
                    <div className="space-y-3.5 border-t border-white/5 pt-5 mb-8">
                      {m.features.map((feat, fIdx) => (
                        <div key={fIdx} className="flex gap-3 items-start text-xs md:text-sm font-sans text-lotus/90">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-brass hover:bg-lotus text-[#0c0f0e] font-sans font-black text-xs tracking-widest uppercase rounded-full transition-all duration-300 text-center"
                    id={`member-btn-${m.id}`}
                  >
                    ACTIVATE MEMBERSHIP
                  </button>
          ...
          <div className="max-w-4xl mx-auto p-8 rounded-3xl bg-gradient-to-r from-orange-950/30 to-stone-900/20 border border-orange-950/40 text-left space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] tracking-widest text-orange-400 uppercase font-black block">EXQUISITE SCRUB PACKAGES</span>
                <h3 className="font-serif text-2xl text-lotus font-bold">The Dual-Therapist Combo Experience</h3>
              </div>
            </div>
            <p className="font-sans text-xs md:text-sm text-lotus/85 leading-relaxed font-light">
            ...
            <div className="pt-2">
              <button
                ...
                className="px-6 py-3 bg-orange-600 hover:bg-orange-500 text-lotus font-sans font-bold text-xs tracking-widest uppercase rounded-full transition-all duration-300"
        ...
        <section id="about-section" className="max-w-6xl mx-auto px-6 py-12 md:px-12 text-left space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="font-sans text-sm text-lotus/80 leading-relaxed font-light">
              ...
              <div className="flex gap-4 pt-2">
                <div className="flex gap-2 items-center text-xs font-sans text-brass">
                  <ShieldCheck size={16} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-4">
              <div className="w-10 h-10 rounded-full bg-brass/15 flex items-center justify-center text-brass">
                <Award size={20} />
              </div>
              <h3 className="font-serif text-xl text-lotus">Expert Male Therapists</h3>
              <p className="font-sans text-xs text-lotus/70 leading-relaxed font-light">
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-4">
              ...
              <h3 className="font-serif text-xl text-lotus">Premium & Discreet</h3>
              <p className="font-sans text-xs text-lotus/70 leading-relaxed font-light">
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-4">
              ...
              <h3 className="font-serif text-xl text-lotus">Tailored For Men</h3>
              <p className="font-sans text-xs text-lotus/70 leading-relaxed font-light">
      ...
      {activeTab === "contact" && (
        <section id="contact-section" className="max-w-7xl mx-auto px-6 py-12 md:px-12 text-left">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
            ...
            <h1 className="font-serif text-4xl md:text-5xl text-lotus font-light">
              Reserve Your <span className="italic text-brass font-normal">Session</span>
            </h1>
            <p className="font-sans text-xs md:text-sm text-stone font-light">
                ...
                {!bookingSuccess ? (
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-1.5">
                        <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Your Name</label>
                        <input
                          type="text"
                          required
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-lotus text-xs font-sans font-medium focus:border-brass/50 focus:outline-none focus:ring-0 transition-colors"
                        />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Phone Number</label>
                        <input
                          type="tel"
                          required
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Email Address</label>
                      <input
                        type="email"
                        required
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-1.5">
                        <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Select Therapy</label>
                        <select
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-stone-900/90 border border-white/10 text-lotus text-xs font-sans font-medium focus:border-brass/50 focus:outline-none focus:ring-0 transition-colors"
                        >
                          {services.map((s) => (
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Session Tier</label>
                        {(() => {
                          ...
                          if (activeSrv.options && activeSrv.options.length > 0) {
                            ...
                            return (
                              <div className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-stone text-xs font-sans font-medium">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-1.5">
                        <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Appointment Date</label>
                        <input
                          type="date"
                          required
                          value={bookingForm.date}
                          onChange={(e) => setBookingForm({ ...bookingForm, date: e.target.value })}
                          className="w-full px-4 py-3 rounded-xl bg-[#0c0f0e] border border-white/10 text-lotus text-xs font-sans font-medium focus:border-brass/50 focus:outline-none focus:ring-0 transition-colors"
                        />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Preferred Time</label>
                        <input
                          type="time"
                          required
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] tracking-wider text-brass uppercase font-bold block">Special Strains / Preferences (Optional)</label>
                      <textarea
                        rows={3}
                        value={bookingForm.notes}
                        onChange={(e) => setBookingForm({ ...bookingForm, notes: e.target.value })}
                        placeholder="Detail any back strain, neck stiffness, specific massage pressure request..."
                        className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-lotus text-xs font-sans font-medium focus:border-brass/50 focus:outline-none focus:ring-0 transition-colors resize-none"
                      />
                    </div>

                    <button
                      type="submit"
                      className="w-full py-4 bg-brass hover:bg-lotus text-[#0c0f0e] font-sans font-black text-xs tracking-widest uppercase rounded-full transition-all duration-300 shadow-xl flex items-center justify-center gap-2.5"
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="font-sans text-xs text-stone max-w-sm mx-auto leading-relaxed">
                    ...
                    <div className="p-5 rounded-2xl bg-white/5 border border-white/5 max-w-md mx-auto text-left space-y-3 font-sans text-xs">
                    ...
                    <p className="text-[11px] font-sans text-brass tracking-wider uppercase font-semibold">
                      ⚡ GENTLEMEN: EXPECT OUR CHIME CALL IN 10 MINUTES
                    </p>

                    <button
                      onClick={handleResetBooking}
                      className="px-6 py-2.5 bg-white/5 hover:bg-white/10 text-lotus border border-white/10 rounded-full font-sans font-bold text-xs tracking-wider uppercase"
                    >
            ...
            <div className="lg:col-span-5 space-y-8 text-left">
              ...
              {!bookingSuccess && (
                <div className="p-6 rounded-3xl bg-gradient-to-br from-amber-950/20 to-stone-900/10 border border-brass/20 frosted-glass space-y-4">
                  <span className="text-[10px] tracking-widest text-brass uppercase font-black block">LIVE PRICING RECKONER</span>
                  <h3 className="font-serif text-2xl text-lotus font-bold">Session Cost Summary</h3>
                  ...
                  <div className="space-y-3 font-sans text-xs">
                    ...
                    <div className="flex justify-between items-baseline">
                      ...
                      <span className="font-serif text-3xl text-brass font-black tracking-tight">{bookingDetails.price}</span>
                    </div>
                  </div>
                  <p className="text-[10px] font-sans text-stone/75 leading-relaxed font-light">
              ...
              <div className="p-6 rounded-3xl border border-white/5 bg-[#0c0f0e] space-y-5">
                <div className="flex items-center gap-2.5">
                  ...
                  <h3 className="font-serif text-xl text-lotus">Pure Bliss JP Nagar</h3>
                </div>

                <div className="space-y-4 font-sans text-xs">
                  <div className="space-y-1">
                    <strong className="text-brass font-bold uppercase block text-[10px]">Prime Location</strong>
                    <p className="text-lotus/85 font-light leading-relaxed">
                      Pure Bliss Wellness, 34/A, 15th Cross Rd, Outer Ring Rd, JP Nagar 2nd Phase, Bangalore - 560078
                    </p>
                  </div>

                  <div className="space-y-1">
                    <strong className="text-brass font-bold uppercase block text-[10px]">Landmark Guidance</strong>
                  ...
                  <div className="space-y-1">
                    <strong className="text-brass font-bold uppercase block text-[10px]">Direct Hotlines</strong>
                    <p className="text-lotus/85 font-light">
                      📞 +91 98860 12345 <br />
                      📞 +91 80 4567 8910
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    <strong className="text-brass font-bold uppercase block text-[10px]">Email Queries</strong>
                ...
                <div className="relative w-full h-44 rounded-2xl overflow-hidden border border-white/5">
                  <div className="absolute inset-0 bg-[#161a19] flex flex-col justify-center items-center text-center p-4 space-y-2">
                    {/* SVG Vector Map Motif */}
                    <svg viewBox="0 0 100 100" className="w-12 h-12 stroke-brass/30 stroke-[0.5] fill-none">
                    ...
                    <span className="font-serif text-sm text-brass italic">GPS Coordinates Activated</span>
                    <span className="font-sans text-[9.5px] text-stone tracking-widest uppercase font-bold">JP Nagar 2nd Phase, Bangalore</span>
                  </div>
                </div>
              </div>
